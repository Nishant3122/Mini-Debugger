...
{ // cout<<"target"<<target_line<<endl;
    ...
    while(getline(file,line)){
       // cout<<line<<endl;
        ...
        string file,addr_srart;
        int line_nu;

        stringstream ss(line);
        ss>>file>>line_nu>>addr_srart;
       
       // cout<<line_nu<<" "<<addr_srart<<endl;
        if(line_nu==target_line){
            //cout<<"target"<<target_line<<" "<<line_nu<<endl;
          return stoull(addr_srart,NULL,16);
        }
    }
   return 0;
}
